...
pub contract nextRoadNFT: NonFungibleToken {
  ...
  pub resource NFT: NonFungibleToken.INFT {
    ...
    init(_ipfsHash: String, _metadata: {String: String}) {
      self.id = nextRoadNFT.totalSupply
      nextRoadNFT.totalSupply = nextRoadNFT.totalSupply + 1
  ...
  pub resource interface CollectionPublic {
    pub fun borrowEntireNFT(id: UInt64): &nextRoadNFT.NFT
  }
  ...
  pub resource Collection: NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, CollectionPublic {
    ...
    pub fun deposit(token: @NonFungibleToken.NFT) {
      let myToken <- token as! @nextRoadNFT.NFT
    ...
    pub fun borrowEntireNFT(id: UInt64): &nextRoadNFT.NFT {
      ...
      return reference as! &nextRoadNFT.NFT
    }
  ...
  pub fun createToken(ipfsHash: String, metadata: {String: String}): @nextRoadNFT.NFT {
